...
void _glfwGetHMONITORContentScaleWin32(HMONITOR handle, float *xscale,
                                       float *yscale);
...
void _glfwGetMonitorContentScaleWin32(_GLFWmonitor *monitor, float *xscale,
                                      float *yscale);
void _glfwGetMonitorWorkareaWin32(_GLFWmonitor *monitor, int *xpos, int *ypos,
